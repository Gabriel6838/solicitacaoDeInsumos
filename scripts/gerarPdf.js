...
function coletarLinhasTabela(tabelaId) {
    ...
    document.querySelectorAll(`#${tabelaId} tbody tr`).forEach(tr => {
        ...
        const tipo = tr.cells[3]?.querySelector('input')?.value || tr.cells[3]?.textContent || '';
...
export function gerarPDF() {
    ...
    const linhasFixos  = coletarLinhasTabela('tabelaFixos');
    ...
    doc.autoTable({
        ...
        headStyles: { textColor: [0,0,0], fillColor: [220,220,220] }, // texto preto e fundo cinza
        columnStyles: {
